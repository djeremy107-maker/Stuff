...
export const gameData: GameData = {
  ...
  achievements: [
    ...
    { id: "naturalist", name: "Naturalist", desc: "Discover 20 species.", icon: "📚", coins: 400, title: "Naturalist", cond: { type: "discover", value: 20 } },
    { id: "hooked", name: "Hooked", desc: "Catch 100 fish.", icon: "🎣", coins: 150, title: "Hooked", cond: { type: "catch_total", value: 100 } },
    { id: "obsessed", name: "Truly Hooked", desc: "Catch 1,000 fish.", icon: "🌀", coins: 800, title: "The Relentless", cond: { type: "catch_total", value: 1000 } },
    { id: "lucky", name: "Lucky!", desc: "Catch a rare fish.", icon: "🍀", coins: 120, cond: { type: "rarity", rarity: "rare" } },
    { id: "trophy", name: "Trophy Catch", desc: "Catch an epic fish.", icon: "🏅", coins: 400, title: "Trophy Hunter", cond: { type: "rarity", rarity: "epic" } },
    { id: "legend", name: "Legend of the Deep", desc: "Catch a legendary fish.", icon: "🐉", coins: 2000, title: "Legend Hunter", cond: { type: "rarity", rarity: "legendary" } },
    ...
    { id: "angler_25", name: "Seasoned Angler", desc: "Reach Fishing level 25.", icon: "⭐", coins: 350, title: "Seasoned Angler", cond: { type: "skill", skill: "fishing", value: 25 } },
    { id: "angler_50", name: "Master Angler", desc: "Reach Fishing level 50.", icon: "👑", coins: 1200, title: "Veteran Angler", cond: { type: "skill", skill: "fishing", value: 50 } },
    ...
    // Skill mastery — the top of each ladder, each with its own equippable title.
    { id: "fishing_99", name: "Angling Mastery", desc: "Reach Fishing level 99.", icon: "🎣", coins: 5000, title: "Master Angler", cond: { type: "skill", skill: "fishing", value: 99 } },
    { id: "foraging_99", name: "Foraging Mastery", desc: "Reach Foraging level 99.", icon: "🧺", coins: 5000, title: "Master Forager", cond: { type: "skill", skill: "foraging", value: 99 } },
    { id: "crafting_99", name: "Crafting Mastery", desc: "Reach Tackle Crafting level 99.", icon: "🛠️", coins: 5000, title: "Master Craftsman", cond: { type: "skill", skill: "crafting", value: 99 } },
    { id: "cooking_99", name: "Cooking Mastery", desc: "Reach Cooking level 99.", icon: "🍳", coins: 5000, title: "Master Chef", cond: { type: "skill", skill: "cooking", value: 99 } },
  ],
